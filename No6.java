...
public class No6 extends Frame {
  ...
  public void paint(Graphics g) {
    ...
    xd[3] = 400;//Change the value from 250 to 400
    yd[3] = 250;//Change the value from 250 to 250
    ...
    xc[4] =  250; // jangan diubah
    yc[4] =  450;// jangan diubah
   ...
   * This method involves active waiting, consuming unnecessary processor capacity.
